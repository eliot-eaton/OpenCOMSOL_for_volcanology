# Model Idea: ring-fault and magma chamber Interaction

**This is an example file to demonstrate the format. Feel free to delete it or use it as inspiration.**

## Research Question
How does including a ring-fault above a spherical magma chamber influence ground deformation? 

## Motivation
Understanding magma chamber-fault interactions is crucial for:
- interpretting ground deformation
...
- Includes magma  body (radius = 1000 m, depth 5000 m )
- Surrounding elastic rock 
- Crack used to model fault (options to add in friction model)
...
## Key Challenges
- Unknown dimensions of fault and fault friction law
...
- Hazard assessment at active volcanoes with ring-faults
